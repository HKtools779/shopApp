...
export const reqPicCode=()=>ajax('/captcha')
//
...
export const reqUseInfos=()=>ajax('/userinfo')
//
// // [10、用户登出](#10用户登出)<br/>
 ...
 * 获取商家信息
 */
export const reqShopInfo = () => ajax2('/info')

/**
 * 获取商家评价数组
 */
export const reqShopRatings = () => ajax2('/ratings')

/**
 * 获取商家商品数组
 */
export const reqShopGoods = () => ajax2('/goods')
